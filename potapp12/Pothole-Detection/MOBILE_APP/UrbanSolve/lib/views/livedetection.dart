...
class _ObjectDetectionScreenState extends State<ObjectDetectionScreen> {
 ...
 @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Object Detection'), // Customizable title
        leading: IconButton(
          icon: Icon(Icons.arrow_back),
          onPressed: () {
            //  Navigator.of(context).pop();
             Navigator.push(context,
                    MaterialPageRoute(builder: (context) => HomePage())); // Navigates back to the previous screen
          },
        ),
        backgroundColor: Color.fromARGB(255, 2, 102, 112), // Customizable color
      ),
